...
const PostShare = () => {
    ...
    return (
        <div className='PostShare'>
            <img stc={localStorage.getItem("image")} alt='' />

            <div>
                <div className='InputContainer'>
                    <input placeholder="What's Happening ?" type='text' id='files' name='file' className='input' value={desc} onChange={(e)=> setDesc(e.target.value)} />
                </div>
                ...
                <div className='postOptions'>
                    ...
                    <div className='option' style={{color: "var(--photo)"}} onClick={()=> videoRef.current.click()} >
                    ...
                    <div style={{display:"none"}}>
                        ...
                        <input type='file' name='videoFile' ref={videoRef} onChange={onVideoChange} />
                    </div>
                </div>
